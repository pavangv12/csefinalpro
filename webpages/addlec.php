...
$lname = $_POST['lect_name'];
$lid = $_POST['lect_id'];

$ss = $_POST['staff'];
if($ss==1)
{
$sql = "INSERT INTO lecture_profile VALUES ('$lname','$lid')";
...
{
$sql = "INSERT INTO nontech_profile VALUES ('$lname','$lid')";
if (mysqli_query($conn, $sql))
	echo "<h2>Record added successfully</h2>";
else
	{
...
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" class="btn btn-login" onclick="location.href='addstaff.php'">Back</button>
                                        </form>
                                    </div> 
