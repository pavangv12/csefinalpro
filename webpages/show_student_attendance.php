...
$sql = "SELECT usn, attendance FROM student_attendance WHERE sub_code='$scode' and sem ='$sem' and sec = '$sec'";
...
$count = mysqli_num_rows($result);
        if($count == 0) {
         ...
         echo "<h3 align=center>Showing attendance of students under $scode subject</h3>" ;
		echo "<table border=1 align=center>";
		echo "<tr><td><b>USN<b></td><td><b>ATTENDANCE<b></td></tr>";
		
		while($row = mysqli_fetch_assoc($result)) {
	   
	   echo "<tr><td>".$row['usn']."</td><td>".$row['attendance']."</td></tr>";
                ...
                <h4></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										...
										<a href="show_student_marks.php" ><button class="btn btn-login">Marks</button></a>
