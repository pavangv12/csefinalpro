...
// echo "<h3 align=center>Showing list of students under $scode subject</h3>" ;
	   ...
	   echo "<tr><td>".$row['lect_name']."</td><td>".$row['lect_designation']."</td><td>".$row['lect_degree'].",".$row['lect_master'].",".$row['lect_phd1'].",".$row['lect_phd2']."</td><td>".$row['lect_experience']."</td></tr>";
...
// echo "<h3 align=center>Showing list of students under $scode subject</h3>" ;
	   ...
	   echo "<tr><td>".$row['nts_name']."</td><td>".$row['nts_designation']."</td><td>".$row['nts_qualification']."</td><td>".$row['nts_exp']."</td></tr>";
