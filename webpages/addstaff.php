        	...
        	<div class="grid">
                ...
                <h4>Enter the deatils:</h4>
								...
								<div class="row ">
                                    ...
                                    <div class="col-md-4">
									<form method="post" action = "addlec.php">
                                        <div class="form-group has-feedback form" >
											<label> Select Staff:</label></br><input type="radio" name="staff" value="1" checked> &nbsp Teaching staff,
											<input type="radio" name="staff" value="2"> &nbsp  Non-Teaching Staff
                                            </div>
                                    </div>
            					</div>
                        		...
                        		<div class="row ">
                                    <div class="col-md-4">
									 <div class="form-group has-feedback form" >
                                           <label> Lecture ID:</label><input type="text" class="form-control cnt" name="lect_id" placeholder="Lecture ID" required>
                                           </div>
                                    </div>
            					</div>
                                ...
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="form-group has-feedback form" >
                                            <label>Lecture Name:</label><input type="text" class="form-control cnt" name="lect_name" placeholder="Lecture Name" required>
