...
$sql = "SELECT * FROM student_marks WHERE sub_code='$scode' and sem='$sem' and sec='$sec'";
...
$count = mysqli_num_rows($result);
        if($count == 0) {
         ...
         echo "<h3 align=center>Showing results of students under $scode subject</h3>" ;
		echo "<table border=1 align=center>";
		
		echo "<tr><td><b>USN<b></td><td><b>Internal Assesment 1<b></td><td><b>Internal Assesment 2<b></td><td><b>ASSIGNMENT<b></td><td><b>CIE<b></td><td><b>SEE<b></td><td><b>GRADE<b></td></tr>";

		while($row = mysqli_fetch_assoc($result)) {
	   
	   echo "<tr><td>".$row['usn']."</td><td>".$row['internal_assessment1']."</td><td>".$row['internal_assessment2']."</td><td>".$row['assignment']."</td><td>".$row['cie']."</td><td>".$row['see']."</td><td>".$row['grade']."</td></tr>";
                ...
                <h4></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										...
										<a href="show_student_attendance.php" ><button class="btn btn-login">Attendance</button></a>
